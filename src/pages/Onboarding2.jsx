    ...
    return (
        <div>
            <div className="bg-page2 h-screen bg-cover bg-center relative flex justify-center">
                <div className='flex flex-col px-5 pt-8 pb-5 text-white bg-cOrange w-[311px] h-[400px] bottom-10 rounded-[48px] absolute text-center font-inter justify-between'>
