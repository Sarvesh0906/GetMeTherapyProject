...
const LoginSuccess = () => {
    ...
    return (
        <div className="bg-page1 h-screen bg-cover bg-center relative">
            <div className="absolute bottom-0 h-[60vh] w-full rounded-t-[24px] flex flex-col items-center bg-white p-7 font-inter">
